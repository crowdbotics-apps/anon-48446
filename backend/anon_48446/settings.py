"""
Django settings for anon_48446 project.
...
WSGI_APPLICATION = 'anon_48446.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "anon_48446 API",
    "DESCRIPTION": "API documentation for anon_48446 App",
    "VERSION": "v1",
}
